...
class EmployerMenuView implements ViewInterface {
	...
	public ViewData create(ModelData modelData, String functionName, String operationName) throws Exception {
		...
		do {
			...
			System.out.println("3. Insert a task");
		...
		userInput.put("employerMenuChoice", choice);
		...
		default: return new ViewData("MainMenu", "");
                ...
                ModelViewControllerConsole.menu = "employer";
		return new ViewData("Task", operationName, new HashMap<>());
	}

	@Override
	public String toString() {
		return "Employer Menu View";
	}		
}
