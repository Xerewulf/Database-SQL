...
public class ModelViewControllerConsole {
	...
	public static void main(String[] args) throws Exception {
		...
		router.put("MainMenu", new Controller(new MainMenuView(), new NopModel()));
                router.put("EmployerMenu", new Controller(new EmployerMenuView(), new NopModel()));
                router.put("GuestMenu", new Controller(new GuessMenuView(), new NopModel()));
                router.put("Employer", new Controller(new EmployerView(), new EmployerModel()));
	...
	public static void connectToDatabase() {
		DatabaseUtilities.host = "DESKTOP-PLGV1C3\\SQLEXPRESS";
		DatabaseUtilities.databaseName = "TaskManager";
